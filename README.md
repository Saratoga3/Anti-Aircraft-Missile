...
* **強大火力配置：** 完整實作「4 聯裝 4 單元」架構，單一系統最大可同時鎖定並攔截 **16 個高空目標**。
* **夜魅剋星：** 自動搜索200~1000格內的夜魅，並發射導彈給予攔截，維護基地領空安全。
* **反玩家中高空突防：** 具備進階鎖定機制，可透過資料包設定或指令指定，對**使用鞘翅高空高速突防的玩家**進行有效攔截與打擊。
...
### 1. 多目標同時攔截
系統內建獨立導引單元，當偵測範圍內出現大量威脅時，導彈會自動分流鎖定，達成最大 16 隻目標的飽和打擊能力。
...
2. 將資料包放入你的 Minecraft 地圖路徑中：
   `saves/你的世界/datapacks/anti_aircraft_missile`
