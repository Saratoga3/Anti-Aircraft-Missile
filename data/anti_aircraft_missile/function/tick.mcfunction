...
#常駐防空導彈陣地
    ...
    #加載防空導彈雷達站
        ...
        #如果存在雷達站，就加載雷達站
        execute at @e[tag=anti_aircraft_missile_radar,limit=1] run function anti_aircraft_missile:forceload/radar
    ...
    #加載防空導彈發射站
        ...
        #如果存在發射站，就加載發射站
        execute at @e[tag=anti_aircraft_missile_launching,limit=1] run function anti_aircraft_missile:forceload/launching
