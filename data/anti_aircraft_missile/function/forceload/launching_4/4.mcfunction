...
#佈署
    ...
    #如果存在加載_發射站4，就強加載該區塊
    execute if entity @e[tag=anti_aircraft_missile_launching_forceload_4] at @e[tag=anti_aircraft_missile_launching_forceload_4] run forceload add ~ ~ ~ ~

#例外狀況

    #如果不存在發射站4，就刪除該區塊的強加載
    execute unless entity @e[tag=anti_aircraft_missile_launching_4] at @e[tag=anti_aircraft_missile_launching_forceload_4] run forceload remove ~ ~ ~ ~
